...
dataIncMissed = data.table(TIME = rep(startTime:endTime, times = 10000),
                           ...
                           ITER = rep(1:10000, each = 30))

# prob of sero conversion
probSeroConvert = 0.871
...
# load probability of being tested on a particular day from 15-29 May
probTestDay =  data.table(read_csv('input/probTestDay.csv'))  # 1/(29-15+1)
...
dataIncMissed[, PROB_TIME_TEST := rep(probTestDay[,PROB], times = .N/15)]
